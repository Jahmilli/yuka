...
type UpdateUserParams struct {
	...
	/* Create.
	   ...
	   User Update
	*/
	Create *api_models.HandlersUpdateUserInput
...
// WithCreate adds the create to the update user params
func (o *UpdateUserParams) WithCreate(create *api_models.HandlersUpdateUserInput) *UpdateUserParams {
	o.SetCreate(create)
	return o
}

// SetCreate adds the create to the update user params
func (o *UpdateUserParams) SetCreate(create *api_models.HandlersUpdateUserInput) {
	o.Create = create
}
